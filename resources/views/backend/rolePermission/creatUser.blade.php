...
<div class="container">
    ...
    <div class="card p-3 mt-2">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.rolePermission.user.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-4 text-center position-relative">
                        ...
                        <label for="imgInp">
                            <img id="user_image"
                                ...
                                class="img-fluid" src="{{ asset('assets/img/uplode-image.jpg') }}" alt="">
                        </label>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" name="user_name" id="user_name" value="" type="text">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" name="user_email" id="user_email" value="" type="text">
                                @error('user_email')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
